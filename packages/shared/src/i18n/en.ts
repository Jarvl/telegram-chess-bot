...
export const en = {
  ...
  'button.challenge': '⚔️ Challenge someone',
  'button.menu': 'Open',
  ...
  'reply.unknown_mention':
    "I haven't seen {name} in this group yet. Reply to one of their messages with /challenge instead.",
  ...
  'command.chess': 'Challenge someone in this group, or open the lobby for games and ratings.',
  ...
  'command.challenge.description': 'Challenge someone: /challenge @name, or reply to them',
  'command.chess.description': 'Open the chess app to challenge someone',
  ...
  'app.lobby.games': 'Games',
  'app.lobby.scope.mine': 'Yours',
  'app.lobby.scope.others': 'Others',
  ...
  'app.new.no_players':
    "The bot hasn't seen anyone else here yet. Reply to their message with /challenge instead.",
  ...
  'app.game.premove_remove_confirm': 'Remove this premove?',
  'app.game.premove_remove_confirm_next': 'Remove this premove and the next one?',
  'app.game.premove_remove_confirm_rest': 'Remove this premove and the {n} after it?',
  ...
  'app.game.tag.won': 'Won',
  'app.game.tag.lost': 'Lost',
  'app.game.tag.draw': 'Draw',
  'app.game.tag.aborted': 'Aborted',
  'app.game.tag.voided': 'Voided',
